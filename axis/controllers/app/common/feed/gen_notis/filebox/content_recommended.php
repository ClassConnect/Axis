...
' . $delML . '
  <img src="/assets/app/img/box/thumbup.png" class="miniImg" style="height:14px;width:14px" /> ' . $idTitle . ' recommended <a href="' . $fbURL . $item['data'][0]['id'] . '" class="js-pjax">' . createConTitle($obj) . '</a>
