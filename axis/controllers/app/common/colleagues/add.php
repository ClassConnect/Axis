...
$(document).ready(function(){
  $('.linkClicker').zclip({
      ...
      copy:'http://www.classconnect.com/?uref=<?= dispUser(user('id'), 'mehash'); ?>'
  });
});
</script>
<style>
...
<fieldset>
    ...
    <div class="sharePop linkClicker" data-original-title="Click to copy link" style="float:left; padding-left:0px;font-weight:bolder;cursor:pointer">
      ...
      <a href="http://twitter.com/intent/tweet?text=Come collaborate with me on ClassConnect! http://www.classconnect.com/?uref=<?= dispUser(user('id'), 'mehash'); ?> %23UnitedWeTeach" onClick="window.open('http://twitter.com/intent/tweet?text=Come collaborate with me on ClassConnect! http://www.classconnect.com/?uref=<?= dispUser(user('id'), 'mehash'); ?> %23UnitedWeTeach', 'mywindow','location=1,status=1,scrollbars=1, width=400,height=300'); return false"><img src="/assets/app/img/colleagues/tw.png" data-original-title="Share with colleagues on Twitter" class="networkShares sharePop" /></a>

      <a href="http://www.facebook.com/share.php?u=http://www.classconnect.com/?uref=<?= dispUser(user('id'), 'mehash'); ?>" onClick="window.open('http://www.facebook.com/share.php?u=http://www.classconnect.com/?uref=<?= dispUser(user('id'), 'mehash'); ?>', 'mywindow','location=1,status=1,scrollbars=1, width=400,height=300'); return false"><img src="/assets/app/img/colleagues/fb.png" data-original-title="Share with colleagues on Facebook" class="networkShares sharePop" /></a>
