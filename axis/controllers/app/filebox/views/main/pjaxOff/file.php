...
// generate main area
$main = createContentView($conID, $cObj, $permissionObj, $perLevel, $dataID) . createFilUI($conID, $cObj, $permissionObj, $perLevel, $dataID) . createCommentView($conID, $cObj, $permissionObj, $perLevel, $dataID);
